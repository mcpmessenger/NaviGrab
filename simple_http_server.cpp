...
public:
    SimpleHTTPServer(int port = 8080) : port_(port), running_(false) {
#ifdef _WIN32
        WSADATA wsaData;
    ...
    bool Start() {
        ...
        running_ = true;
        std::cout << "🚀 NaviGrab C++ HTTP Server started on port " << port_ << std::endl;
...
int main() {
    std::cout << "🕷️ NaviGrab C++ HTTP Server" << std::endl;
    std::cout << "============================" << std::endl;
